...
public class Dragonair extends Dratini{
    ...
    public Dragonair(String nome, int level) {
        super(nome, level);
        this.especie = "Dragonair";
        this.tipo1="Dragão";
        this.tipo2="Null";
    }
    ...
    public void gerarStats() {
        ...
        this.vida = (int) Math.floor(0.01 * (2 * 61 + (Math.round((Math.random() + 1) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 22) * 21.17))) * this.level) + this.level + 10);
        /*Other Stats*/
        ...
        this.ataqueEspecial = (int) ((int) Math.floor(0.025 * (2 * 70 + (Math.round((Math.random() + 2) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 2) * this.level))) * this.level) + 5));

        this.defesaEspecial = (int) ((int) Math.floor(0.025 * (2 * 70 + (Math.round((Math.random() + 2) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 2) * this.level))) * this.level) + 5));

        this.velocidade = (int) ((int) Math.floor(0.025 * (2 * 70 + (Math.round((Math.random() + 2) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 2) * this.level))) * this.level) + 5));
