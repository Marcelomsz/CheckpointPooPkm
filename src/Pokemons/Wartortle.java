...
public class Wartortle extends Squirtle {
    public Wartortle(String nome, int level) {
        super(nome, level);
    ...
    public void gerarStatus() {
        this.peso = ((Math.round(Math.random() * 10)) * 0.1) + 22.5;
        this.altura = ((Math.round(Math.random() * 10)) * 0.04) + 0.8;
        this.vida = (int) Math.floor(0.01 * (2 * 59 + (Math.round((Math.random() + 1) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 22) * 21.17))) * this.level) + this.level + 10);
        /*Other Stats*/
        this.ataque = (int) ((int) Math.floor(0.025 * (2 * 63 + (Math.round((Math.random() + 2) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 2) * this.level))) * this.level) + 5));

        this.defesa = (int) ((int) Math.floor(0.025 * (2 * 80 + (Math.round((Math.random() + 2) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 2) * this.level))) * this.level) + 5));
        ...
        this.velocidade = (int) ((int) Math.floor(0.025 * (2 * 58 + (Math.round((Math.random() + 2) * 100)) + Math.floor(0.25 * (Math.round((Math.random() + 2) * this.level))) * this.level) + 5));
